...
function CommentArea(props) {
    ...
    const refresh = () => {
        ...
        axios.get(`http://192.168.0.7:8080/${type}/${props.id}`)
            .then(res => {
    ...
    const like = (commentId) => {
        if (cookieParser.getCookieByName("email")) {
            axios.put(`http://192.168.0.7:8080/favorite/${props.type}/${props.id}/${commentId}/${email}`, {}, {
                headers: {
    ...
    const unlike = (commentId) => {
        if (cookieParser.getCookieByName("email")) {
            axios.put(`http://192.168.0.7:8080/unFavorite/${props.type}/${props.id}/${commentId}/${email}`, {}, {
                headers: {
                    'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
                }
            })
    ...
    const onSubmit = (ev) => {
        if (cookieParser.getCookieByName("email")) {
            ...
            const type = props.page == 'NoteDetailPage' ? 'note' : 'post'
            if (comment.length > 0) {
                axios.post(`http://192.168.0.7:8080/comment/${props.id}`, tempComment, {
                    headers: {
                        'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
                    }
                })
    ...
    const setTheBest = (commentIds) => {
        ...
        axios.put(`http://192.168.0.7:8080/post/qa/best/${props.id}/${commentIds}`, {}, {
            headers: {
                'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
            }
        })
    ...
    const commentEdit = (floor) => {
        ...
        axios.put(`http://192.168.0.7:8080/comment/${props.id}/${floor}`, data, {
            headers: {
                'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
            }
        })
    ...
    const commentDelete = (floor) => {
        axios.delete(`http://192.168.0.7:8080/comment/${props.id}/${floor}`, {
            headers: {
                'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
            }
        })
