...
const OptionMenu = (props) => {
  ...
  const archive = () => {
    if (props.isAnswered) {
      axios.put(`192.168.0.7:8080/post/archive/${props.id}`, {}, {
        headers: {
  ...
  const setStatus = () => {
    axios.put(`192.168.0.7:8080/post/publish/${props.id}`, {}, {
      headers: {
        'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
      }
    })
  ...
  const setNoteStatus = () => {
    ...
    axios.put(`192.168.0.7:8080/note/publish/${props.noteId}`, {}, {
      headers: {
        'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
      }
    })
  ...
  const versionPublish = (index) => {
    axios.put(`192.168.0.7:8080/note/publish/${props.id}/${index}`, {}, {
      headers: {
        'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
      }
    })
  ...
  const chooseBest = (id) => {
    ...
    axios.put(`192.168.0.7:8080/post/reward/best/${props.postId}/${id}`, {}, {
      headers: {
        'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
      }
    })
  ...
  const chooseRef = (id) => {
    ...
    axios.put(`192.168.0.7:8080/post/reward/reference/${props.postId}/${id}`, {}, {
      headers: {
        'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
      }
    })
  ...
  const approve = (email) => {
    ...
    axios.put(`192.168.0.7:8080/post/add/${props.postId}/${email}`, {}, {
      headers: {
        'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
      }
    })
  ...
  const reject = (email) => {
    ...
    axios.delete(`192.168.0.7:8080/post/apply/${props.postId}/${email}`, {
      headers: {
        'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
      }
    })
  ...
  const deletePost = () => {
    ...
    if (props.type == "note") {
      axios.put(`192.168.0.7:8080/note/delete/${props.id}/${props.folderId}`, {}, {
        headers: {
          'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
        }
      })
      ...
      axios.delete(`192.168.0.7:8080/post/${props.id}`, {
        headers: {
          'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
        }
      })
  ...
  const favorite = () => {
    if (props.email) {
      axios.put(`192.168.0.7:8080/favorite/note/${props.id}/${props.email}`, {}, {
        headers: {
          'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
        }
      })
  ...
  const chooseManager = (userObj) => {
    axios.put(`192.168.0.7:8080/note/admin/${props.noteId}/${userObj.email}`, {}, {
      headers: {
        'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
      }
    })
  ...
  /*const kickUser = (email) => {
    ...
    axios.post(`192.168.0.7:8080/schedule/vote/${props.id}`, data,{
                    headers: {
                        'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
                      }
                })
