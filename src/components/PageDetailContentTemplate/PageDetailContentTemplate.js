...
const PageDetailContentTemplate = (props) => {
    ...
    const apply = (content) => {
        ...
        axios.put(`http://192.168.0.7:8080:8080/post/apply/${props.postId}`, data, {
            headers: {
    ...
    const buyNote = () => {
        ...
        let success = false;
        if (email) {
            axios.put(`http://192.168.0.7:8080:8080/coin/note/${email}/${props.noteId}`, {}, {
                headers: {
                    'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
                }
            })
    ...
    const submitRewardNote = () => {
        axios.put(`http://192.168.0.7:8080:8080/note/submit/${props.noteId}`, {}, {
            headers: {
                'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
            }
        })
    ...
    const withdrawRewardNote = () => {
        axios.put(`http://192.168.0.7:8080:8080/note/withdraw/${props.noteId}`, {}, {
            headers: {
                'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
            }
        })
    ...
    const handleOk = () => {
        ...
        console.log("data", data)
        axios.post(`http://192.168.0.7:8080:8080/schedule/vote/${props.postId}`, data, {
            headers: {
                'Authorization': 'Bearer ' + cookieParser.getCookieByName("token"),
            }
        })
