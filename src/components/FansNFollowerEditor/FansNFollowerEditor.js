    ...
    return (
        <div className='FansNFollowerEditor'>
            <Row className='FansNFollowerEditor__Row'>
                ...
                {props.isSwitch&&isFans&& <Col className='FansNFollowerEditor__Fans' span={5} onClick={()=>{removeFans()}}>
                ...
                {!props.isSwitch&&isFollow&& <Col className='FansNFollowerEditor__Fans' span={5} onClick={()=>{cancelFollowing()}}>
                    {/* <UserAddOutlined className='Profile__Follow__Icon' style={{ fontSize: '22px' }} /> */}
                    <Text className='FansNFollowerEditor__unFans' cls='Small' fontSize={'16'} content='追蹤中'></Text>
                </Col >}
                {!props.isSwitch&&!isFollow&& <Col className='FansNFollowerEditor__Fans__UnFollow' span={5} onClick={()=>{cancelFollowing()}}>
                    {/* <UserAddOutlined className='Profile__Follow__Icon' style={{ fontSize: '22px' }} /> */}
