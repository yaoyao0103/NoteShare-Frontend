...
const MyEditor = (props) => {
  ...
  useEffect(() => {
    ...
    const editor = geditorConfig(assets, props.noteId, props.version, props.isCollab? props.isCollab:false, props.email);
    setEditor(editor);
    
  }, [props.noteId, props.version, props.isCollab, props.email, assets]);
