    ...
    useEffect(() => {
        async function getQnAById() {
            try {
                ...
                await axios.get('http://localhost:8080/search/post/'+props.keyWord+'/' + String(pageNumber-1) + '/20?department='+props.department+'&subject='+props.subject+'&haveQA='+haveQA+'&sortBy='+sortBy).then((res) => {
