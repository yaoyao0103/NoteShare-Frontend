    ...
    useEffect(() => {
        async function getCollabById() {
            try {
                ...
                await axios.get('http://localhost:8080/search/post/'+props.keyWord+'/'+ String(pageNumber - 1) + '/20?department='+props.department+'&subject='+props.subject+'&haveCollaboration=' + haveCollaboration + '&sortBy=' + sortBy).then((res) => {
