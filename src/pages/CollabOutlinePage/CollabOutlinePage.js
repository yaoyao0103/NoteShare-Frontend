    ...
    useEffect(() => {
        ...
        async function getCollabById() {
            try {
                ...
                await axios.get('192.168.0.7:8080/search/post/' + String(props.pageNumber - 1) + '/20?keyword=' + (props.keyword ? props.keyword : '') + '&department=' + (props.department ? props.department : '') + '&subject=' + (props.subject ? props.subject : '') + '&haveCollaboration=' + true + '&sortBy=' + sortBy).then((res) => {
