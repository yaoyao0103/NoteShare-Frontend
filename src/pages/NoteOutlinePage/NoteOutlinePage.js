    ...
    useEffect(() => {
        async function getNoteById() {
            try {
                ...
                await axios.get('http://localhost:8080/search/note/'+props.keyWord+'/' + String(pageNumber-1) + '/10?department='+props.department+'&subject='+props.subject+'&haveNormal='+haveNormal+'&sortBy='+sortBy).then((res) => {
